document.addEventListener('DOMContentLoaded', function() {
    // Sample translations - in a real app, these would come from an API or JSON file
    const translations = {
        en: {
            app_name: "AquaPulse",
            nav_home: "Home",
            ...
            btn_login: "Login",
            btn_signup: "Sign Up",
            hero_title: "Join the Fight Against Water Wastage",
            ...
            faq1_answer: "To report a leak, simply open the AquaPulse app, tap the \"Report Leak\" button, take a photo of the leak, and tag its location using your phone's GPS. Add any additional details and submit. It takes less than a minute!",
            faq2_question: "How are rewards calculated?",
            faq2_answer: "You earn 100 points for each verified leak report. If your report gets verified by 3 other community members, you earn an extra 50 points. Bonus points are awarded for being the first to report a leak in an area.",
            faq3_question: "What happens after I report a leak?",
            faq3_answer: "Your report is immediately visible to other users nearby who can verify it. Once verified, it's sent to local water authorities. You'll receive updates on the status until the leak is fixed.",
            faq4_question: "Is my personal information safe?",
            faq4_answer: "Yes, we prioritize your privacy. Your exact location is only shared with authorities for leak resolution. Community members see generalized locations. Read our Privacy Policy for details.",
            faq5_question: "Can I use AquaPulse without a smartphone?",
            faq5_answer: "Currently, the mobile app is our primary platform, but we're working on SMS-based reporting for feature phones. You can also ask a friend or community volunteer to report on your behalf.",
            ...
            footer_copyright: "© 2023 AquaPulse. All rights reserved.",
            ...
            modal_urban: "Urban",
            modal_rural: "Rural",
            modal_terms: "I agree to the Terms of Service and Privacy Policy",
        ...
        hi: {
            ...
            btn_login: "लॉग इन",
            btn_signup: "साइन अप",
            hero_title: "पानी की बर्बादी के खिलाफ लड़ाई में शामिल हों",
            hero_subtitle: "लीक की रिपोर्ट करें, मुद्दों को सत्यापित करें और अपने समुदाय में पानी बचाने में मदद करते हुए पुरस्कार अर्जित करें।",
            btn_report_leak: "लीक की रिपोर्ट करें",
            btn_learn_more: "और जानें",
            stat_reports: "10,000+",
            stat_reports_label: "लीक की रिपोर्ट",
            stat_verified: "7,500+",
            stat_verified_label: "सत्यापित मामले",
            stat_liters: "25M+",
            stat_liters_label: "लीटर बचाए",
            stat_users: "50,000+",
            stat_users_label: "सक्रिय उपयोगकर्ता",
            features_title: "मुख्य विशेषताएं",
            feature_geo_title: "जियो-टैग्ड लीक रिपोर्टिंग",
            feature_geo_desc: "सटीक रिपोर्टिंग के लिए जीपीएस तकनीक के साथ पानी के रिसाव के सटीक स्थान का पता लगाएं।",
            feature_crowd_title: "क्राउड सत्यापन",
            feature_crowd_desc: "समुदाय के सदस्य अधिकारियों द्वारा कार्रवाई से पहले सटीकता सुनिश्चित करने के लिए रिपोर्ट किए गए रिसाव को सत्यापित कर सकते हैं।",
            feature_ai_title: "एआई-पावर्ड रिस्क मैपिंग",
            feature_ai_desc: "हमारा एआई ऐतिहासिक डेटा और पैटर्न के आधार पर पानी के रिसाव के लिए उच्च जोखिम वाले क्षेत्रों की भविष्यवाणी करता है।",
            feature_rewards_title: "प्रोत्साहित सहभागिता",
            feature_rewards_desc: "अपने समुदाय में रिसाव की रिपोर्ट करने और सत्यापित करने के लिए अंक और पुरस्कार अर्जित करें।",
            feature_dashboard_title: "प्रभाव डैशबोर्ड",
            feature_dashboard_desc: "अपने व्यक्तिगत प्रभाव और समुदाय-व्यापी जल बचत को वास्तविक समय में ट्रैक करें।",
            feature_recognition_title: "मान्यता प्रणाली",
            feature_recognition_desc: "आपके योगदान के लिए अपने समुदाय में वॉटर हीरो के रूप में मान्यता प्राप्त करें।",
            how_it_works_title: "एक्वापल्स कैसे काम करता है",
            step1_title: "लीक देखें",
            step1_desc: "अपने पड़ोस, सड़क या सार्वजनिक स्थान पर पानी का रिसाव देखें।",
            step2_title: "एक्वापल्स के साथ रिपोर्ट करें",
            step2_desc: "ऐप खोलें, एक फोटो लें और स्थान को टैग करें। इसमें सिर्फ 30 सेकंड लगते हैं!",
            step3_title: "समुदाय सत्यापन",
            step3_desc: "आस-पास के अन्य उपयोगकर्ता इसकी वैधता की पुष्टि करने के लिए रिपोर्ट को सत्यापित कर सकते हैं।",
            step4_title: "अधिकारियों को सूचित किया गया",
            step4_desc: "सत्यापित रिपोर्ट तुरंत स्थानीय जल अधिकारियों को भेजी जाती हैं।",
            step5_title: "समाधान ट्रैक करें",
            step5_desc: "लीक ठीक होने तक अपनी रिपोर्ट की स्थिति का अनुसरण करें।",
            step6_title: "पुरस्कार अर्जित करें",
            step6_desc: "जल संरक्षण में अपने योगदान के लिए अंक और मान्यता प्राप्त करें।",
            dashboard_title: "रीयल-टाइम वॉटर कंजर्वेशन डैशबोर्ड",
            dashboard_leaks_reported: "लीक की रिपोर्ट",
            dashboard_leaks_fixed: "लीक ठीक हुए",
            dashboard_water_saved: "पानी बचाया",
            ...
            rewards_subtitle: "जल संरक्षण में आपका योगदान अनदेखा नहीं किया जाता",
            reward_bronze_title: "वॉटर सेवर",
            reward_bronze_desc: "इस बैज और 500 अंकों को अर्जित करने के लिए 5 सत्यापित लीक की रिपोर्ट करें।",
            reward_silver_title: "वॉटर गार्डियन",
            reward_silver_desc: "इस बैज और 2,000 अंकों को अर्जित करने के लिए 20 सत्यापित लीक की रिपोर्ट करें।",
            reward_gold_title: "वॉटर हीरो",
            reward_gold_desc: "इस बैज और 5,000 अंकों को अर्जित करने के लिए 50 सत्यापित लीक की रिपोर्ट करें।",
            reward_platinum_title: "वॉटर चैंपियन",
            reward_platinum_desc: "इस प्रतिष्ठित बैज को अर्जित करने के लिए 100+ सत्यापित लीक की रिपोर्ट करें।",
            rewards_points_title: "अपने अंकों को रिडीम करें",
            rewards_points_desc: "अपने अर्जित अंकों को रोमांचक पुरस्कारों के लिए एक्सचेंज करें:",
            reward_500: "मोबाइल रिचार्ज वाउचर",
            reward_1000: "शॉपिंग डिस्काउंट कूपन",
            reward_2500: "स्मार्ट वॉटर बोतल",
            reward_5000: "हमारे वॉटर हीरोज वॉल पर फीचर्ड",
            testimonials_title: "हमारे उपयोगकर्ता क्या कहते हैं",
            testimonial1_text: "\"एक्वापल्स ने मेरे घर के पास एक लीक की रिपोर्ट करना बहुत आसान बना दिया। 2 दिनों के भीतर, नगरपालिका की टीम आई और इसे ठीक कर दिया। मुझे अपनी रिपोर्ट के लिए अंक भी मिले!\"",
            testimonial1_location: "बेंगलुरु, कर्नाटक",
            testimonial2_text: "\"एक समुदाय नेता के रूप में, मैं अपने सभी निवासियों को एक्वापल्स का उपयोग करने के लिए प्रोत्साहित करता हूं। हमने लीक की तुरंत रिपोर्ट करके हजारों लीटर पानी बचाया है।\"",
            ...
            faq1_question: "मैं पानी के रिसाव की रिपोर्ट कैसे करूं?",
            faq1_answer: "लीक की रिपोर्ट करने के लिए, बस एक्वापल्स ऐप खोलें, \"लीक की रिपोर्ट करें\" बटन पर टैप करें, लीक की एक फोटो लें और अपने फोन के जीपीएस का उपयोग करके इसके स्थान को टैग करें। कोई अतिरिक्त विवरण जोड़ें और सबमिट करें। इसमें एक मिनट से भी कम समय लगता है!",
            faq2_question: "पुरस्कारों की गणना कैसे की जाती है?",
            faq2_answer: "आप प्रत्येक सत्यापित लीक रिपोर्ट के लिए 100 अंक अर्जित करते हैं। यदि आपकी रिपोर्ट 3 अन्य समुदाय सदस्यों द्वारा सत्यापित की जाती है, तो आपको अतिरिक्त 50 अंक मिलते हैं। किसी क्षेत्र में लीक की पहली रिपोर्ट करने के लिए बोनस अंक दिए जाते हैं।",
            faq3_question: "लीक की रिपोर्ट करने के बाद क्या होता है?",
            faq3_answer: "आपकी रिपोर्ट तुरंत आस-पास के अन्य उपयोगकर्ताओं के लिए दिखाई देती है जो इसे सत्यापित कर सकते हैं। एक बार सत्यापित हो जाने पर, यह स्थानीय जल अधिकारियों को भेजी जाती है। लीक ठीक होने तक आपको स्थिति पर अपडेट प्राप्त होगा।",
            faq4_question: "क्या मेरी व्यक्तिगत जानकारी सुरक्षित है?",
            faq4_answer: "हां, हम आपकी गोपनीयता को प्राथमिकता देते हैं। आपका सटीक स्थान केवल लीक समाधान के लिए अधिकारियों के साथ साझा किया जाता है। समुदाय के सदस्य सामान्यीकृत स्थान देखते हैं। विवरण के लिए हमारी गोपनीयता नीति पढ़ें।",
            faq5_question: "क्या मैं स्मार्टफोन के बिना एक्वापल्स का उपयोग कर सकता हूं?",
            faq5_answer: "वर्तमान में, मोबाइल ऐप हमारा प्राथमिक प्लेटफॉर्म है, लेकिन हम फीचर फोन के लिए एसएमएस-आधारित रिपोर्टिंग पर काम कर रहे हैं। आप किसी मित्र या समुदाय के स्वयंसेवक से आपकी ओर से रिपोर्ट करने के लिए भी कह सकते हैं।",
            partners_title: "हमारे साझेदार",
            footer_about: "एक्वापल्स समुदाय की भागीदारी और प्रौद्योगिकी के माध्यम से पानी की बर्बादी से लड़ने के लिए एक नागरिक-नेतृत्व वाली पहल है।",
            footer_links_title: "त्वरित लिंक",
            footer_resources_title: "संसाधन",
            footer_faq: "एफएक्यू",
            footer_blog: "ब्लॉग",
            footer_water_tips: "पानी बचाने के टिप्स",
            ...
            modal_login_title: "एक्वापल्स में लॉग इन करें",
            modal_email: "ईमेल",
            ...
            modal_signup_title: "एक खाता बनाएँ",
            modal_name: "पूरा नाम",
            modal_phone: "फोन नंबर",
            modal_confirm: "पासवर्ड की पुष्टि करें",
            modal_urban: "शहरी",
            modal_rural: "ग्रामीण",
            modal_terms: "मैं सेवा की शर्तों और गोपनीयता नीति से सहमत हूं",
            modal_have_account: "पहले से ही एक खाता है?",
        },
